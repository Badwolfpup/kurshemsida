...
const Ovningar = () => {
    ...
    return (
      <div className="p-6 lg:p-10 max-w-6xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="font-display text-2xl font-bold text-foreground">Övningar</h1>
        </div>
        <AdminExercises />
      </div>
    );
  ...
  return <OvningarDeltagare />;
};

const OvningarDeltagare = () => {
  ...
  if (!user) return <div className="p-6 lg:p-10 max-w-6xl mx-auto"><div className="bg-card rounded-2xl shadow-card border border-border p-8 text-center"><Dumbbell className="h-10 w-10 text-muted-foreground mx-auto mb-3" /><p className="text-muted-foreground">Logga in för att se övningar.</p></div></div>;
  ...
  return (
    <div className="p-6 lg:p-10 max-w-6xl mx-auto">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="font-display text-2xl font-bold text-foreground">Övningar</h1>
          <p className="text-sm text-muted-foreground">{exercises.length} övningar tillgängliga</p>
        </div>
      </div>
