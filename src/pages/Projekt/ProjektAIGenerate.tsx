    ...
    if (AIProject) {
      try {
        await assertService.submitProjectFeedback({
          ...
          learningGoals: AIProject.learningGoals ?? undefined,
          userStories: AIProject.userStories ?? undefined,
          designSpecs: AIProject.designSpecs ?? undefined,
          assetsNeeded: AIProject.assetsNeeded ?? undefined,
          starterHtml: AIProject.starterHtml ?? undefined,
          bonusChallenges: AIProject.bonusChallenges ?? undefined,
